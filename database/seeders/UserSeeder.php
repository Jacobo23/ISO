...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('users')->insert(['name' => 'Juan.Jacobo','email' => 'jc_jacobo@outlook.com','password' => '$2y$10$Pf05.rmwei/neBzcCn/.SueO5MZ3FJzqXtf/ZJmxlTx20Ni3rPv2q','perfil' => 'Empleado general','tipo' => 'Responsable','activo' => 1]);
